...
def create_dataset():
    ...
    Dir_Bic = "/home/jakaria/Super_Resolution/Datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS/Bic/x4"
    Dir_LR = "/home/jakaria/Super_Resolution/Datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS/LR/x4"
    files = glob.glob("/home/jakaria/Super_Resolution/Datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS/HR/1000/*.txt")
    ...
    for file in files:
        ...
        destinationH = os.path.join(os.path.dirname(Dir_LR), '1000', img_file)
        print(sourceH)
        print(destinationH)
        ...
        destinationHtxt = os.path.join(os.path.dirname(Dir_LR), '1000', txt_file)
